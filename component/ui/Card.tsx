...
export const Card = ({imgUrl, title, description, liveUrl, className, children, ...props} : CardProps) => {
    ...
    return(
        <div className={`h-96 w-96 bg-white/10 backdrop-blur-lg rounded-lg flex flex-col gap-2 hover:shadow-2xl/50 shadow-stone-50 mt-2 mb-4 hover:scale-105 transition transform
          md:pb-4 md:h-128 md:w-112.5 lg:w-[95%]`} {...props}>
            ...
            <div className="flex flex-col gap-3 items-center md:h-48"> 
